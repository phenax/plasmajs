...
describe('StaticContentRouter Middleware', () => {
	...
	const scRouter= 
		config => _ =>
			<StaticContentRouter {...ctx} dir={STATIC_DIRECTORY} hasPrefix={false} compress={true} {...config} />;
	...
	describe('Static routing without prefix', () => {
		...
		it('should send the correct file', () => {
			...
			expect(ctx.calledWith).to.eql(path.resolve(STATIC_DIRECTORY + FILE_EXISTS_URL));
		});
